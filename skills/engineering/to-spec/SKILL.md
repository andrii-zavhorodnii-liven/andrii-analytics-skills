...
Issue tracker convention: **GitHub Issues** via the `gh` CLI when the repo has a git remote; local markdown under `.scratch/<feature>/` when it doesn't. Triage labels are the canonical role names verbatim.
